...
static const CGFloat kAlertButtonBottomMargin = 46;
static const CGFloat kAlertButtonSideMargin = 30;
static const CGFloat kAlertButtonsBetweenMargin = 3;
static const CGFloat kAlertButtonHeight = 50;

static const CGFloat kAlertTitleLabelHeight = 30;
static const CGFloat kAlertTitleLabelTopMargin = 55;
...
static const CGFloat kAlertButtonFontSize = 17;

static NSString* kAlertOKButtonNormalColor = @"#6E6E6E";
static NSString* kAlertOKButtonHighlightColor = @"#2a36b1";
static NSString* kAlertCancelButtonNormalColor = @"#7AA300";
static NSString* kAlertCancelButtonHighlightColor = @"#7AA300";
...
- (void)initDropAlert
{
   ...
   // [self makeBackgroundBlur];//Kavya commented this on 7 Feb 2015
...
- (void)makeAlertPopupView
{
    ...
    UIImageView *imgView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"popupbg_6.png"]];
    imgView.frame=alertView.frame;
...
- (void)makeAlertTitleLabel
{
    ...
    titleLabel.textColor = [VSCore getColor:@"1a1a1a" withDefault:[UIColor darkGrayColor]];
    [titleLabel setTextAlignment:NSTextAlignmentCenter];
//    titleLabel.font = [titleLabel.font fontWithSize:kAlertTitleLabelFontSize];
    titleLabel.font=[UIFont fontWithName:OTHER_FONT size:28];
...
- (void)makeAlertDescriptionLabel
{
    ...
    descriptionLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 250, kAlertDescriptionLabelHeight)];
    
    if ([descrptionString containsString:@"You have successfully created flashbaq code"])
    {
        descriptionLabel.center = CGPointMake(CGRectGetWidth(alertView.frame)/2 + 15, kAlertTitleLabelTopMargin + CGRectGetHeight(titleLabel.frame) + kALertDescriptionLabelTopMargin);
    ...
    descriptionLabel.textColor = [VSCore getColor:@"1a1a1a" withDefault:[UIColor darkGrayColor]];
//    descriptionLabel.font = [descriptionLabel.font fontWithSize:kAlertDescriptionLabelFontSize];
    descriptionLabel.font=[UIFont fontWithName:TITLE_FONT size:22];
    // Line Breaking
...
- (void)makeAlertButton:(BOOL)hasCancelButton
{
    ...
    if (hasCancelButton) {
        ...
        cancelButton.layer.cornerRadius = 5; // this value vary as per your desire
        cancelButton.clipsToBounds = YES;
        
        [okButton setFrame:CGRectMake(2, 0, CGRectGetWidth(alertView.frame)/2 - kAlertButtonSideMargin, kAlertButtonHeight)];
        ...
        cancelButton.titleLabel.font = [UIFont fontWithName:TITLE_FONT size:kAlertButtonFontSize];
...
//    [okButton.titleLabel setFont:[okButton.titleLabel.font fontWithSize:kAlertButtonFontSize]];
    okButton.titleLabel.font = [UIFont fontWithName:TITLE_FONT size:kAlertButtonFontSize];
