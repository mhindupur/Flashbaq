...
//static CGFloat const kPageControlHeight = 35; //kavya commented on 2 December 2014
static CGFloat const kPageControlHeight = 240;
...
- (instancetype)initWithContents:(NSArray *)contents {
    ...
    self.shouldMaskBackground = NO;//kavya set this to NO
...
- (void)generateView {
    ...
    // create the action button if we were given button text
        ...
        self.loginButton.titleLabel.font = [UIFont fontWithName:self.buttonFontName size:self.buttonFontSize];
      ...
      /*Set up constraints for login Button */
    NSLayoutConstraint *bottomconstraint = [NSLayoutConstraint constraintWithItem:self.loginButton attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:1.0f constant:0.0f];
    
    [self.view addConstraint:bottomconstraint];
    
   NSLayoutConstraint *xconstraint = [NSLayoutConstraint constraintWithItem:self.loginButton attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeading multiplier:1.0f constant:0.0f];
    
    [self.view addConstraint:xconstraint];

    NSLayoutConstraint *_width = [NSLayoutConstraint constraintWithItem:self.loginButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem: nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:self.view.frame.size.width/2];
    
    [self.view addConstraint:_width];
    
    NSLayoutConstraint *heightconstraint = [NSLayoutConstraint constraintWithItem:self.loginButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem: nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:75.0f];//75
    
    [self.view addConstraint:heightconstraint];

    // create one more action button for SignUp button
    
    self.signUpButton = [[UIButton alloc] init];
    
    [self.signUpButton setBackgroundColor:[VSCore getColor:SEA_GREEN withDefault:[UIColor whiteColor]]];
    [self.signUpButton setTitle:@"Sign Up" forState:UIControlStateNormal];
    self.signUpButton.titleLabel.font = [UIFont fontWithName:OTHER_FONT size:22.0];
    self.signUpButton.titleLabel.textColor = [UIColor whiteColor];

    
    [self.loginButton setBackgroundColor:[VSCore getColor:PURPLE_COLOR withDefault:[UIColor whiteColor]]];
    [self.loginButton setTitle: @"Login" forState:UIControlStateNormal];
    self.loginButton.titleLabel.font = [UIFont fontWithName:OTHER_FONT size:22.0];
    ...
    /*Set up constraints for login Button */
    NSLayoutConstraint *_bottomconstraint = [NSLayoutConstraint constraintWithItem:self.signUpButton attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:1.0f constant:0.0f];
    
    [self.view addConstraint:_bottomconstraint];
    
    NSLayoutConstraint *_xconstraint = [NSLayoutConstraint constraintWithItem:self.signUpButton attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeading multiplier:1.0f constant:self.view.frame.size.width/2];
    
    [self.view addConstraint:_xconstraint];
    
    NSLayoutConstraint *width = [NSLayoutConstraint constraintWithItem:self.signUpButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem: nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:self.view.frame.size.width/2];
    
    [self.view addConstraint:width];
    
    NSLayoutConstraint *_heightconstraint = [NSLayoutConstraint constraintWithItem:self.signUpButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem: nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:75.0f];
